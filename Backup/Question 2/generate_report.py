"""
Script to generate professional Word document report from Customer Purchasing Behavior Analysis
"""
...
def create_report():
    """Create the professional Word document report"""
    ...
    doc.add_paragraph()
    doc.add_paragraph(
        "[SCREENSHOT PLACEHOLDER: Insert screenshot of dataset head() output showing first few rows]"
    ).runs[0].font.italic = True
    doc.add_paragraph(
        "[SCREENSHOT PLACEHOLDER: Insert screenshot of df.info() output showing dataset structure]"
    ).runs[0].font.italic = True
    ...
    doc.add_paragraph()
    doc.add_paragraph(
        "[SCREENSHOT PLACEHOLDER: Insert screenshot of data cleaning results showing before/after counts]"
    ).runs[0].font.italic = True
    
    doc.add_heading("4.2 Feature Engineering", level=2)
    
    doc.add_paragraph(
        "Three key customer-level features were created for clustering analysis:"
    )
    
    features = [
        "TotalSpending: Sum of all transaction values per customer",
        "TransactionCount: Number of unique invoices per customer",
        "AvgBasketSize: Average quantity per transaction (TotalQty / TransactionCount)"
    ]
    ...
    doc.add_paragraph()
    doc.add_paragraph(
        "[SCREENSHOT PLACEHOLDER: Insert screenshot of customer_df.head() showing aggregated features]"
    ).runs[0].font.italic = True
    ...
    doc.add_paragraph()
    doc.add_paragraph(
        "[SCREENSHOT PLACEHOLDER: Insert screenshot of k-Means silhouette score plot (k=2 to 10)]"
    ).runs[0].font.italic = True
    ...
    doc.add_paragraph()
    doc.add_paragraph(
        "[SCREENSHOT PLACEHOLDER: Insert screenshot of kNN distance plot for DBSCAN parameter tuning]"
    ).runs[0].font.italic = True
    ...
    doc.add_paragraph()
    doc.add_paragraph(
        "[SCREENSHOT PLACEHOLDER: Insert screenshot of k-Means clusters visualization in PCA space]"
    ).runs[0].font.italic = True
    doc.add_paragraph(
        "[SCREENSHOT PLACEHOLDER: Insert screenshot of DBSCAN clusters visualization in PCA space]"
    ).runs[0].font.italic = True
    ...
    doc.add_paragraph()
    doc.add_paragraph(
        "[SCREENSHOT PLACEHOLDER: Insert screenshot of autoencoder model summary]"
    ).runs[0].font.italic = True
    ...
    doc.add_paragraph()
    doc.add_paragraph(
        "[SCREENSHOT PLACEHOLDER: Insert screenshot of autoencoder training loss plot showing train/val loss over epochs]"
    ).runs[0].font.italic = True
    ...
    doc.add_paragraph()
    doc.add_paragraph(
        "[SCREENSHOT PLACEHOLDER: Insert screenshot of customer clusters in autoencoder latent space]"
    ).runs[0].font.italic = True
    ...
    doc.add_paragraph()
    doc.add_paragraph(
        "[SCREENSHOT PLACEHOLDER: Insert side-by-side comparison of PCA vs Autoencoder cluster visualizations]"
    ).runs[0].font.italic = True
    ...
    doc.add_paragraph()
    doc.add_paragraph(
        "[SCREENSHOT PLACEHOLDER: Insert screenshot of binary matrix head() showing basket format]"
    ).runs[0].font.italic = True
    ...
    doc.add_paragraph()
    doc.add_paragraph(
        "[SCREENSHOT PLACEHOLDER: Insert screenshot of top 10 frequent itemsets]"
    ).runs[0].font.italic = True
    ...
    doc.add_paragraph()
    doc.add_paragraph(
        "[SCREENSHOT PLACEHOLDER: Insert screenshot of top 10 association rules from notebook output]"
    ).runs[0].font.italic = True
    ...
    # ==================== APPENDIX ====================
    doc.add_page_break()
    doc.add_heading("Appendix: Screenshot Instructions", level=1)
    
    doc.add_paragraph(
        "The following screenshots should be inserted at the indicated locations throughout the document:"
    )
    
    screenshot_locations = [
        ("Section 3: Dataset Overview", [
            "Dataset head() output showing first few rows",
            "df.info() output showing dataset structure"
        ]),
        ("Section 4: Methodology", [
            "Data cleaning results showing before/after counts",
            "customer_df.head() showing aggregated features"
        ]),
        ("Section 5.1: k-Means Clustering", [
            "k-Means silhouette score plot (k=2 to 10)"
        ]),
        ("Section 5.2: DBSCAN Clustering", [
            "kNN distance plot for DBSCAN parameter tuning"
        ]),
        ("Section 5.4: Cluster Visualization", [
            "k-Means clusters visualization in PCA space",
            "DBSCAN clusters visualization in PCA space"
        ]),
        ("Section 6.1: Autoencoder Architecture", [
            "Autoencoder model summary"
        ]),
        ("Section 6.2: Autoencoder Training", [
            "Autoencoder training loss plot showing train/val loss over epochs"
        ]),
        ("Section 6.3: Latent Space Clustering", [
            "Customer clusters in autoencoder latent space"
        ]),
        ("Section 6.4: PCA vs Autoencoder Comparison", [
            "Side-by-side comparison of PCA vs Autoencoder cluster visualizations"
        ]),
        ("Section 7.1: Data Preparation", [
            "Binary matrix head() showing basket format"
        ]),
        ("Section 7.2: FP-Growth Algorithm", [
            "Top 10 frequent itemsets"
        ]),
        ("Section 7.4: Top 10 Strongest Rules", [
            "Top 10 association rules from notebook output"
        ])
    ]
    
    for section, screenshots in screenshot_locations:
        doc.add_heading(section, level=2)
        for screenshot in screenshots:
            para = doc.add_paragraph(screenshot, style='List Bullet')
    
    # Save document
    output_path = os.path.join(os.path.dirname(__file__), "Customer_Purchasing_Behavior_Report.docx")
